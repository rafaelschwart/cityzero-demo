...
const DATA = {
  ...
  today: {
    ...
    classesToday: [
      ...
      { name: "Pilates Sculpt", at: "10 AM", booked: 16, cap: 20, wait: 0, done: true },
      { name: "Vinyasa Yoga", at: "11 AM", booked: 12, cap: 22, wait: 0, done: true },
  ...
  heatmap: {
    ...
    classes: [
      ...
      { d: 0, h: 10, name: "Pilates Sculpt" }, { d: 1, h: 10, name: "Pilates Sculpt" },
      { d: 2, h: 10, name: "Pilates Sculpt" }, { d: 3, h: 10, name: "Pilates Sculpt" },
      { d: 4, h: 10, name: "Pilates Sculpt" },
      { d: 0, h: 11, name: "Vinyasa Yoga" }, { d: 1, h: 11, name: "Vinyasa Yoga" },
      { d: 2, h: 11, name: "Vinyasa Yoga" }, { d: 3, h: 11, name: "Vinyasa Yoga" },
      { d: 4, h: 11, name: "Vinyasa Yoga" },
      { d: 5, h: 8, name: "Vinyasa Yoga" },
  ...
  classes: {
    ...
    photos: {
      ...
      "Pilates Sculpt": "assets/classes/pilates.jpg",
      "Vinyasa Yoga": "assets/classes/vinyasa.jpg",
    },
    /* ficha por clase: instructor (REAL solo cuando es verificable publicamente:
       Beto=fundador/Zumba, Andreina=Pilates Sculpt segun su propio IG) + agenda */
    info: {
      "Zumba": { inst: "Beto Perez", instPhoto: "assets/team/beto.jpg", real: true, dur: 55,
        desc: "The house signature. Founder-led high-energy Zumba in the main studio; the class their 110K audience knows them for.",
        agenda: [["0-5", "Warm-up groove"], ["5-40", "Full Zumba block, 8 tracks"], ["40-50", "Toning + core"], ["50-55", "Cooldown"]] },
      "Pilates Sculpt": { inst: "Andreina Carvo", instPhoto: "assets/team/andreina.jpg", real: true, dur: 50,
        desc: "Low-impact sculpt on the mat: control, posture and deep core. One of the studio's fastest-growing formats.",
        agenda: [["0-10", "Breath + alignment"], ["10-35", "Sculpt series: core, glutes, arms"], ["35-45", "Burnout block"], ["45-50", "Stretch"]] },
      "Vinyasa Yoga": { inst: "Team coach", real: false, dur: 55,
        desc: "Flow yoga linking breath to movement. The recovery anchor of the weekly schedule.",
        agenda: [["0-10", "Grounding + sun salutations"], ["10-40", "Standing flow"], ["40-55", "Deep stretch + savasana"]] },
      "Full Body Conditioning": { inst: "Team coach", real: false, dur: 55,
        desc: "The 6 AM engine: strength + conditioning circuits before work. Consistent 80%+ fill all week.",
        agenda: [["0-10", "Dynamic warm-up"], ["10-45", "4 circuit rounds"], ["45-55", "Finisher + mobility"]] },
      "Body Fit": { inst: "Team coach", real: false, dur: 55,
        desc: "Bands and bodyweight at lunch. The slot with the most room to grow on the whole grid.",
        agenda: [["0-10", "Activation"], ["10-45", "Band circuits"], ["45-55", "Core + stretch"]] },
      "Spin": { inst: "Team coach", real: false, dur: 45,
        desc: "Ride to the beat. Small room, loyal crowd, waitlists on peak days.",
        agenda: [["0-5", "Saddle setup + spin-up"], ["5-35", "Intervals: climbs + sprints"], ["35-45", "Flush + stretch"]] },
      "Jiu Jitsu": { inst: "Team coach", real: false, dur: 60,
        desc: "Fundamentals and rolling for all levels. Evening anchor for the combat crowd.",
        agenda: [["0-15", "Drills"], ["15-45", "Technique of the day"], ["45-60", "Live rolls"]] },
      "Cardio Dance": { inst: "Team coach", real: false, dur: 50,
        desc: "Choreo cardio that fills Friday nights and Saturday mornings. Waitlists prove the demand.",
        agenda: [["0-5", "Groove warm-up"], ["5-40", "3 choreo blocks"], ["40-50", "Cooldown"]] },
    },
    ...
    list: [
      ...
      { name: "Pilates Sculpt", coach: "Andreina Carvo", cap: 20 },
      { name: "Vinyasa Yoga", coach: "Team", cap: 22 },
    ],
    grid: [
      ...
      { cls: "Pilates Sculpt", slots: [15, 17, 14, 18, 16, 19], wait: [0, 0, 0, 2, 0, 3] },
      { cls: "Vinyasa Yoga", slots: [11, 13, 10, 14, 12, 16] },
    ],
    insights: [
